  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link
          href="/empleos"
          className="px-6 py-3 rounded-[10px] bg-brand text-white font-semibold hover:bg-brand-hover transition-colors"
        >
          Ver todos los empleos
        </Link>
        <Link
          href="/"
          className="px-6 py-3 rounded-[10px] border-2 border-brand text-brand font-semibold hover:bg-brand-tint transition-colors"
        >
          Ir al inicio
        </Link>
      </div>
