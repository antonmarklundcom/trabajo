...
export default function EmployerForm({ categories, cities }: Props) {
    ...
    return (
      <div className="text-center py-8">
        <div className="w-14 h-14 rounded-full bg-[#ECFDF5] flex items-center justify-center mx-auto mb-4">
          <svg width="28" height="28" viewBox="0 0 20 20" fill="currentColor" className="text-[#16794C]">
            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          </svg>
        </div>
        <h2 className="text-xl font-bold text-[#16181D] mb-2">¡Recibimos tu solicitud!</h2>
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-6">
      ...
      <div className="pt-4 pb-4 border-b border-t border-[#E5E7EB]">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-[#5B6472]">
          Detalles del puesto
        </h2>
      </div>
      ...
      <button
        ...
        className="w-full py-3.5 px-6 rounded-[10px] bg-[#2557D6] hover:bg-[#1E47B8] text-white font-semibold text-base transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
      >
